...
if [[ ARGC -gt 0 ]] then
  ...
  foreach USER ($@)
    ...
    gcc -g -m32 -fno-stack-protector -z execstack -z norelro -fno-pie -no-pie -Wl,--section-start=.text=0x$BB -mpreferred-stack-boundary=2 -o obj/$USER/$BINNAME program.c
  end
else
