class pachev_ftp_server_1_path_traversal::config {
  ...
  $port = "21" ##$secgen_parameters['port'][0]
  $leaked_filenames = ["flagtest"] ##$secgen_parameters['leaked_filenames']
  $strings_to_leak = ["this is a list of strings that are secrets / flags","another secret"]
  $strings_to_pre_leak = ["this is a string that's leaked before an attack"] ##$secgen_parameters['strings_to_pre_leak']
  $pre_leaked_filenames = ["leaked_info_filename"] ##$secgen_parameters['pre_leaked_filenames']
  $user = "leakedusername" ##$secgen_parameters['leaked_username'][0]
  $leaked_password = "password" ##$secgen_parameters['leaked_password'][0]
